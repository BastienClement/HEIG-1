...
Conceptuellement, les fichiers sur lesquels travail actuellement l'utilisateur (appelé le \textit{répertoire de travail}) sont à la fin de la chaine et formeront la prochaine version du projet lors du commit.
...
\subsubsection{\textit{Staging area}}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=11cm]{img_areas} \cite{progit}
