...
GitHub est un service indépendant d'hébergement et de gestion de développement de logiciels lancé le 10~avril~2008, soit 2 ans seulement après le projet Git.
Il est un facteur ayant participé à son adoption rapide par les développeurs et est aujourd'hui une plateforme incontournable dans le monde du logiciel open-source, utilisée même par de grands noms tel que Google et Microsoft. 
